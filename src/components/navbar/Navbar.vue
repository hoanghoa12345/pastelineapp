    ...
    <div class="flex flex-wrap justify-between items-center">
      <div class="flex justify-start items-center">
        ...
        >
          ...
          <span
            class="hidden sm:block self-center text-2xl font-semibold whitespace-nowrap dark:text-white"
            >{{ APP_NAME }}</span
          >
        </router-link>
        <div>
          <button
            type="button"
            class="hidden sm:block relative md:w-96"
      ...
      <div class="flex items-center lg:order-2 relative">
        ...
        <Menu as="div">
          ...
          <!-- Dropdown menu -->
          <MenuItems
            class="absolute right-0 overflow-hidden z-50 w-80 my-4 max-w-sm text-base list-none bg-white divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700 rounded-xl"
        ...
        <Menu as="div">
          ...
          <!-- Dropdown menu -->
          <MenuItems
            class="absolute right-0 w-64 overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white divide-y divide-gray-100 shadow-lg dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
            id="apps-dropdown"
          >
            <div
              class="block py-2 px-4 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-600 dark:text-gray-300"
...
import { BellIcon, AppIcon, MenuIcon, CloseIcon } from "./icons";
