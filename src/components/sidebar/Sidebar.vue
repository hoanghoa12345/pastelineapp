<template>
  ...
  <aside :class="`fixed top-0 left-0 z-40 w-64 h-screen pt-14 transition-transform ${drawer.isOpen ? 'transform-none' : '-translate-x-full'
