<template>
    <Teleport to="#app">
        <Transition enter-active-class="ease-out duration-300" enter-from-class="opacity-0" enter-to-class="opacity-100"
            ...
            <div v-if="props.show" class="fixed inset-0 z-30 overflow-y-auto p-4 sm:p-6 md:p-20" role="dialog"
                aria-modal="true">

                <div @click="emit('hide')" class="fixed inset-0 bg-gray-500 bg-opacity-25 transition-opacity"
                ...
                <Transition enter-active-class="ease-out duration-300" enter-from-class="opacity-0 scale-95"
                    ...
                    <div
                        ...
                        <div class="relative">
                            ...
                            <input type="text"
                                class="h-12 w-full border-0 bg-transparent pl-11 pr-4 text-gray-800 placeholder-gray-400 focus:ring-0 sm:text-sm outline-none"
                                placeholder="Search...">
                        </div>

                        <!-- Default state, show/hide based on command palette state. -->
                        <ul v-if="state === 'default'"
                            ...
                            <li class="p-2">
                                ...
                                <ul class="text-sm text-gray-700">
                                    ...
                                    <li class="group flex cursor-default select-none items-center rounded-md px-3 py-2">
                                        ...
                                        <svg class="h-6 w-6 flex-none text-gray-400" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <li class="p-2">
                                ...
                                <ul class="text-sm text-gray-700">
                                    ...
                                    <li class="group flex cursor-default select-none items-center rounded-md px-3 py-2">
                                        <!-- Heroicon name: outline/folder-add -->
                                        <svg class="h-6 w-6 flex-none text-gray-400" xmlns="http://www.w3.org/2000/svg"
                                            fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <ul v-if="state === 'results'" class="max-h-96 overflow-y-auto p-2 text-sm text-gray-700">
                            <!-- Active: "bg-indigo-600 text-white" -->
                            <li class="group flex cursor-default select-none items-center rounded-md px-3 py-2">
                                <!-- Active: "text-white", Not Active: "text-gray-400" -->
                                <!-- Heroicon name: outline/folder -->
                                <svg class="h-6 w-6 flex-none text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none"
                        ...
                        <div v-if="state === 'empty'" class="py-14 px-6 text-center sm:px-14">
                            <!-- Heroicon name: outline/folder -->
                            ...
                            <p class="mt-4 text-sm text-gray-900">We couldn't find any projects with that term. Please try
                                again.
                            </p>
                        </div>
