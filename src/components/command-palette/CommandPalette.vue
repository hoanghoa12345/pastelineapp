              ...
              <Combobox v-model="selected">
                <div class="">
                  ...
                  <TransitionRoot
                    ...
                    leaveTo="opacity-0"
                    @after-leave="query = ''">
                    <ComboboxOptions v-if="filteredNotes" class="max-h-[20rem] w-full overflow-auto py-4 text-base" :hold="true">
                      <div
                      ...
                      <ComboboxOption
                        ...
                        <li
                          class="cursor-pointer py-4 px-4 mb-2 mx-2 rounded-md text-sm"
                          :class="{
...
let filteredNotes = computed(() => {
  ...
  return query.value === ""
    ? notes.value
    : notes.value.filter((note) => note.title.toLowerCase().replace(/\s+/g, "").includes(query.value.toLowerCase().replace(/\s+/g, "")));
});
