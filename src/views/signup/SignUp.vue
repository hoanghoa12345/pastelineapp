                    ...
                    <form class="space-y-4 md:space-y-6" @submit.prevent="signUp">
                        <div>
                            ...
                            <input type="email" name="email" id="email"
                                ...
                                placeholder="name@email.com" v-model="form.email">
                            <span v-if="v$.email.$error" class="text-red-500 text-sm">{{ v$.email.$errors[0].$message
                            }}</span>
                        </div>
                        <div>
                            <label for="password"
                            ...
                            <span v-if="v$.password.password.$error" class="text-red-500 text-sm">{{
                        ...
                        <div>
                            ...
                            <span v-if="v$.password.confirm.$error" class="text-red-500 text-sm">{{
                        ...
                        <span v-if="v$.acceptTerms.$error" class="text-red-500 text-sm">{{
                            v$.acceptTerms.$errors[0].$message }}</span>
                        <button type="submit"
...
const { form, signUp, userStore, v$ } = useSignUp()
</script>